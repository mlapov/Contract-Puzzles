...
describe('Game3', function () {
  async function deployContractAndSetVariables() {
    ...
    //const signer = [address1, address2, address3];
    const signer = [signer1, signer2, signer3];
    //console.log("signers", signer);
    //console.log("signer", signer[2]);
  ...
  it('should be a winner', async function () {
    ...
    const address1 = await signer[0].getAddress();
    const address2 = await signer[1].getAddress();
    const address3 = await signer[2].getAddress();
